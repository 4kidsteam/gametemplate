...
{
    public class Math004BottomGraphicController : MonoBehaviour
    {

        [SerializeField] Transform number1Transform, number2Transform;
        [SerializeField] Transform countObj1, countObj2;
        public Math004CountObjGroup[] countObjGroup1, countObjGroup2;
...
#if UNITY_EDITOR
    [CustomEditor(typeof(Math004BottomGraphicController))]
    public class Math001BottomGraphicControllerInspector : Editor
    {
        public override void OnInspectorGUI()
        {
            base.OnInspectorGUI();
            ((Math004BottomGraphicController)target).UpdateOnInspector();
        }
    }
