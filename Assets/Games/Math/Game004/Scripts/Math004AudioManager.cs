...
namespace Math.Game004
{
    ...
    public class Math004AudioManager : MonoBehaviour
    {

        public static Math004AudioManager Inst;
...
#if UNITY_EDITOR
    [UnityEditor.CustomEditor(typeof(Math004AudioManager), true)]
    public class Math001AudioManagerInspector : Editor
    {
        Math004AudioManager targetClass;

        public void OnEnable()
        {
            targetClass = (Math004AudioManager)target;
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                if(targetClass == null) targetClass = (Math004AudioManager)target;
