...
namespace Math.Game004
{
    ...
    public class Math004SpineAnimationController : MonoBehaviour
    {
...
#if UNITY_EDITOR
    [UnityEditor.CustomEditor(typeof(Math004SpineAnimationController), true)]
    public class Math004SpineAnimationControllerInspector : Editor
    {
        Math004SpineAnimationController targetClass;

        public void OnEnable()
        {
            targetClass = (Math004SpineAnimationController)target;
