...
namespace Math.Game003
{
    ...
    public class Math003SpineAnimationController : MonoBehaviour
    {
        ...
        {
            IdleAnim = AnimIndexGUIPopup("Idle anim", IdleAnim);
        }
        ...
        [HideInInspector] public int IdleAnim;
...
#if UNITY_EDITOR
    [UnityEditor.CustomEditor(typeof(Math003SpineAnimationController), true)]
    public class Math003SpineAnimationControllerInspector : Editor
    {
        Math003SpineAnimationController targetClass;

        public void OnEnable()
        {
            targetClass = (Math003SpineAnimationController)target;
