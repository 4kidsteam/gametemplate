...
namespace Math.Game001
{
    ...
    public class Math001SpineAnimationController : MonoBehaviour
    {
...
#if UNITY_EDITOR
    [UnityEditor.CustomEditor(typeof(Math001SpineAnimationController), true)]
    public class Math001SpineAnimationControllerInspector : Editor
    {
        Math001SpineAnimationController targetClass;

        public void OnEnable()
        {
            targetClass = (Math001SpineAnimationController)target;
