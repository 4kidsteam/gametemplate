...
namespace Math.Game001
{
    ...
    public class Math001AudioManager : MonoBehaviour
    {

        public static Math001AudioManager Inst;
...
#if UNITY_EDITOR
    [UnityEditor.CustomEditor(typeof(Math001AudioManager), true)]
    public class Math001AudioManagerInspector : Editor
    {
        Math001AudioManager targetClass;

        public void OnEnable()
        {
            targetClass = (Math001AudioManager)target;
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                if(targetClass == null) targetClass = (Math001AudioManager)target;
